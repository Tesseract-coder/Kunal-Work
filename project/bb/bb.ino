...
const char* ssid = "dlink"; const char* password = "ilovechips";

int ledPin = 2; // GPIO2 WiFiServer server(80);
...
int value = LOW; if (request.indexOf("/LED=ON") != -1) { digitalWrite(ledPin, HIGH); value = HIGH; } if (request.indexOf("/LED=OFF") != -1) { digitalWrite(ledPin, LOW); value = LOW; }
